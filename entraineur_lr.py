"""
BOT DE PAPER TRADING — V2 LOGISTIC REGRESSION (Optimisé Quant)
Améliorations vs V1 :
...
def executer_trades(portfolio):
    ...
    print(f"\n📅 Analyse du {aujourd_hui} (Logistic Regression)")
...
if __name__ == "__main__":
    print("🤖 BOT LOGISTIC REGRESSION V2 (31 Tickers)")
