"""
BOT DE PAPER TRADING — V2 GRADIENT BOOSTING (ATR HYBRIDE)
Améliorations :
...
def afficher_resume(portfolio):
    ...
    print("\n" + "═" * 75)
    print(f"💼 RÉSUMÉ Gradient Boosting (V2 ATR Hybride) — {aujourd_hui}")
    print("═" * 75)
...
if __name__ == "__main__":
    print("🤖 BOT PAPER TRADING V2 - GRADIENT BOOSTING (ATR HYBRIDE)")
